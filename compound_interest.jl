...
# ╔═╡ 8a4df9d4-635a-4ed9-80d7-25a36c0ddc29
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 547cd100-9d98-11ee-0e51-e3350a36398d
md"# Continuous Compound Interest"

# ╔═╡ c35ef020-231a-4926-8c2d-607b2d024abc
md"### The problem"

# ╔═╡ 1feb2b17-3354-4065-b664-56da415d66fb
md"##### Ordinary Differential Equation(ODE)"

# ╔═╡ ce1dbe9a-8a85-474b-9fbe-f9d99626fe2d
md"$\frac{du}{dt} = pu$"

# ╔═╡ a9fd83ab-36c6-4b2d-95f8-f606329247ad
md"##### DifferentialEquations.jl"

# ╔═╡ 5933165f-d0a7-43ef-a815-5d5474d2c912
md"$\frac{du}{dt} = f(u, p, t)$"

# ╔═╡ 80e622c1-ecaa-4d98-abb0-b0da56383045
md"##### Define the Problem"

# ╔═╡ c872f976-1318-40ff-82f0-5d47aeae7760
f(u, p, t) = p*u

# ╔═╡ cfada246-cbc6-43da-af1e-303ad2a9ecdc
u_begin = 1.0 #u is the bank account balance

# ╔═╡ fe38c12a-5290-47a5-8586-205923fe8437
p = 1.0 #p is the annual interest rate

# ╔═╡ 1de34ec0-38ff-41d5-924b-705a079b56fe
#time is time in year
t_begin = 0.0

# ╔═╡ c901b687-ebf6-4eb7-be36-3084b13e9c2b
t_end = 1.0

# ╔═╡ 6c3327d8-7454-4a9b-85f2-0302ea72fe81
t_span= (t_begin, t_end)

# ╔═╡ 5b422942-72a2-4829-af6a-c6b8bc60b608
prob = ODEProblem(f, u_begin, t_span, p)

# ╔═╡ 883a5415-07c6-47b9-b6d8-55422ca8cccd
solution = solve(prob)

# ╔═╡ fba0ee06-a838-42cd-8c25-94901b10ad7e
plot(solution, 
	legend = false,
	linewidth = 2,
...
git-tree-sha1 = "b983d7e2b869375c74b1197fb65209b6f528d28f"
...
git-tree-sha1 = "e047c47fca2ac1ac687e006a257f96632fb95a7b"
